...
extern const u8 BattleScript_PrintFullParty[];
...
extern const u8 BattleScript_AffectionCureSleep[];
extern const u8 BattleScript_AffectionCurePoison[];
extern const u8 BattleScript_AffectionCureBurn[];
extern const u8 BattleScript_AffectionCureFreeze[];
extern const u8 BattleScript_AffectionCureParalysis[];
...
extern const u8 BattleScript_KyogreRains[];
extern const u8 BattleScript_GroudonSun[];
...
extern const u8 BattleScript_FlashFireBoost_NextTarget[];
...
extern const u8 BattleScript_AffectionSurvivedMsg[];
