...
extern const u8 MetatileScript_RegionMap[];
extern const u8 MetatileScript_RunningShoesManual[];
extern const u8 MetatileScript_PictureBookShelf[];
extern const u8 MetatileScript_BookShelf[];
extern const u8 MetatileScript_PokemonCenterClock[];
extern const u8 MetatileScript_PokemonCenterSleepSign[];
