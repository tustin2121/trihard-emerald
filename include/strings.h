...
extern const u8 gText_StarterLocation[];
...
extern const u8 gText_DefaultName_Boy01[];
extern const u8 gText_DefaultName_Boy02[];
extern const u8 gText_DefaultName_Boy03[];
extern const u8 gText_DefaultName_Boy04[];
extern const u8 gText_DefaultName_Boy05[];
extern const u8 gText_DefaultName_Boy06[];
extern const u8 gText_DefaultName_Boy07[];
extern const u8 gText_DefaultName_Boy08[];
extern const u8 gText_DefaultName_Boy09[];
extern const u8 gText_DefaultName_Boy10[];
extern const u8 gText_DefaultName_Boy11[];
extern const u8 gText_DefaultName_Boy12[];
extern const u8 gText_DefaultName_Boy13[];
extern const u8 gText_DefaultName_Boy14[];
extern const u8 gText_DefaultName_Boy15[];
extern const u8 gText_DefaultName_Boy16[];
extern const u8 gText_DefaultName_Boy17[];
extern const u8 gText_DefaultName_Boy18[];
extern const u8 gText_DefaultName_Boy19[];
extern const u8 gText_DefaultName_Boy20[];

extern const u8 gText_DefaultName_Girl01[];
extern const u8 gText_DefaultName_Girl02[];
extern const u8 gText_DefaultName_Girl03[];
extern const u8 gText_DefaultName_Girl04[];
extern const u8 gText_DefaultName_Girl05[];
extern const u8 gText_DefaultName_Girl06[];
extern const u8 gText_DefaultName_Girl07[];
extern const u8 gText_DefaultName_Girl08[];
extern const u8 gText_DefaultName_Girl09[];
extern const u8 gText_DefaultName_Girl10[];
extern const u8 gText_DefaultName_Girl11[];
extern const u8 gText_DefaultName_Girl12[];
extern const u8 gText_DefaultName_Girl13[];
extern const u8 gText_DefaultName_Girl14[];
extern const u8 gText_DefaultName_Girl15[];
extern const u8 gText_DefaultName_Girl16[];
extern const u8 gText_DefaultName_Girl17[];
extern const u8 gText_DefaultName_Girl18[];
extern const u8 gText_DefaultName_Girl19[];
extern const u8 gText_DefaultName_Girl20[];
...
extern const u8 gText_PartyIsFull[];
extern const u8 gText_WontHaveEffect[];
...
extern const u8 gText_DeadPokemonState[];
...
extern const u8 gText_YouWantTM[];
...
extern const u8 gTextSailTo_Petalburg[];
extern const u8 gTextSailTo_Slateport[];
...
extern const u8 gTextSailTo_Dewford[];
...
extern const u8 gText_DontBeAThief[];
