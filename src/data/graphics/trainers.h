...
const u32 gTrainerFrontPic_Wally[] = INCBIN_U32("graphics/trainers/front_pics/logan_front_pic.4bpp.lz");
const u32 gTrainerPalette_Wally[] = INCBIN_U32("graphics/trainers/palettes/logan.gbapal.lz");
...
const u32 gTrainerFrontPic_ProtagMale5[] = INCBIN_U32("graphics/trainers/front_pics/protag_male_4.4bpp.lz");  // TODO {PROTAG5_GRAPHICS}
...
const u32 gTrainerFrontPic_ProtagFemale5[] = INCBIN_U32("graphics/trainers/front_pics/protag_female_4.4bpp.lz");  // TODO {PROTAG5_GRAPHICS}
...
const u32 gTrainerFrontPic_RubySapphireBrendan[] = INCBIN_U32("graphics/trainers/front_pics/rs_brendan_front_pic.4bpp.lz");
const u32 gTrainerPalette_RubySapphireBrendan[] = INCBIN_U32("graphics/trainers/palettes/rs_brendan.gbapal.lz");

const u32 gTrainerFrontPic_RubySapphireMay[] = INCBIN_U32("graphics/trainers/front_pics/rs_may_front_pic.4bpp.lz");
const u32 gTrainerPalette_RubySapphireMay[] = INCBIN_U32("graphics/trainers/palettes/rs_may.gbapal.lz");
...
const u8 gTrainerBackPic_RubySapphireBrendan[] = INCBIN_U8("graphics/trainers/back_pics/rs_brendan_back_pic.4bpp");
const u8 gTrainerBackPic_RubySapphireMay[] = INCBIN_U8("graphics/trainers/back_pics/rs_may_back_pic.4bpp");
...
const u8 gTrainerBackPic_ProtagMale1[] = INCBIN_U8("graphics/trainers/back_pics/protag_male_1.4bpp");
const u8 gTrainerBackPic_ProtagMale2[] = INCBIN_U8("graphics/trainers/back_pics/protag_male_2.4bpp");
const u8 gTrainerBackPic_ProtagMale3[] = INCBIN_U8("graphics/trainers/back_pics/protag_male_3.4bpp");
const u8 gTrainerBackPic_ProtagMale4[] = INCBIN_U8("graphics/trainers/back_pics/protag_male_4.4bpp");
const u8 gTrainerBackPic_ProtagMale5[] = INCBIN_U8("graphics/trainers/back_pics/protag_male_4.4bpp");  // TODO {PROTAG5_GRAPHICS}
const u8 gTrainerBackPic_ProtagFemale1[] = INCBIN_U8("graphics/trainers/back_pics/protag_female_1.4bpp");
const u8 gTrainerBackPic_ProtagFemale2[] = INCBIN_U8("graphics/trainers/back_pics/protag_female_2.4bpp");
const u8 gTrainerBackPic_ProtagFemale3[] = INCBIN_U8("graphics/trainers/back_pics/protag_female_3.4bpp");
const u8 gTrainerBackPic_ProtagFemale4[] = INCBIN_U8("graphics/trainers/back_pics/protag_female_4.4bpp");
const u8 gTrainerBackPic_ProtagFemale5[] = INCBIN_U8("graphics/trainers/back_pics/protag_female_4.4bpp");  // TODO {PROTAG5_GRAPHICS}
