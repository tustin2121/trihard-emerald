static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 27, 20},
    {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 22, 6},
    {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 16, 39},
    {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), 5, 22},
    ...
    {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), 14, 4},
