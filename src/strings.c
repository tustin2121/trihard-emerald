...
const u8 gExpandedPlaceholder_HeUppercase[] = _("He");
const u8 gExpandedPlaceholder_SheUppercase[] = _("She");
const u8 gExpandedPlaceholder_HeLowercase[] = _("he");
const u8 gExpandedPlaceholder_SheLowercase[] = _("she");
const u8 gExpandedPlaceholder_HimUppercase[] = _("Him");
const u8 gExpandedPlaceholder_HerUppercase[] = _("Her");
const u8 gExpandedPlaceholder_HimLowercase[] = _("him");
const u8 gExpandedPlaceholder_HerLowercase[] = _("her");
const u8 gExpandedPlaceholder_HisUppercase[] = _("His");
const u8 gExpandedPlaceholder_HersUppercase[] = _("Hers");
const u8 gExpandedPlaceholder_HisLowercase[] = _("his");
const u8 gExpandedPlaceholder_HersLowercase[] = _("hers");
const u8 gExpandedPlaceholder_Sir[] = _("sir");
const u8 gExpandedPlaceholder_Miss[] = _("miss");
const u8 gExpandedPlaceholder_Boy[] = _("boy");
const u8 gExpandedPlaceholder_Girl[] = _("girl");
const u8 gExpandedPlaceholder_Dude[] = _("dude");
const u8 gExpandedPlaceholder_Gurl[] = _("gurl");
const u8 gExpandedPlaceholder_Man[] = _("man");
const u8 gExpandedPlaceholder_Lady[] = _("lady");
...
const u8 gExpandedPlaceholder_Logan[] = _("Logan");
...
const u8 gYN_No_[] =            _("No…");
const u8 gYN_NoBang[] =         _("No!");
...
const u8 gYN_UhOk[] =           _("Uh… Ok");
const u8 gYN_UgNo[] =           _("Ug… No");
const u8 gYN_Ugh[] =            _("Ugh…");
...
const u8 gText_DefaultName_Girl15[] = _("Jasmine");
...
const u8 gText_JumpToWhere[] = _("Jump to where?");
const u8 gMenuText_Use[] = _("Use");
const u8 gMenuText_Toss[] = _("Toss");
const u8 gMenuText_FieldMoves[] = _("Field Move");
...
const u8 gText_Advice09[] = _("Dad's advice…\nYou already failed at {POKEMON},\ldon't you fail at math too! Homework!{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice10[] = _("Mom's advice…\nI don't like you hanging out with those\lhoodlums, {PLAYER}.\pWhat have they ever done for you\nbesides get you in trouble?{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice11[] = _("{RIVAL_ALOLA}'s advice…\nYou gotta hide them in your clothes,\llike this. And don't act suspicious.{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice12[] = _("{RIVAL_ALOLA}'s advice…\nSometimes you just gotta talk it out.\lTalk to me, {PLAYER}, what's wrong?{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice13[] = _("{RIVAL_ALOLA}'s advice…\nSomeone could get hurt, {PLAYER}!\lWe don't want to hurt nobody!{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice14[] = _("{RIVAL_ALOLA}'s advice…\nGrip with your toes. Feel the waves\lunder the board. You feel them?{PAUSE_UNTIL_PRESS}");
const u8 gText_Advice15[] = _("{RIVAL_ALOLA}'s advice…\nWe got plenty of beds in Po Town.\pNothing says you have to sleep near\nyour crazy mom and dad all the time.{PAUSE_UNTIL_PRESS}");
    const u8 gText_Advice16[] = _("Guzma's advice…\n {PAUSE_UNTIL_PRESS}");
    const u8 gText_Advice17[] = _("Plumeria's advice…\n {PAUSE_UNTIL_PRESS}");
    const u8 gText_Advice18[] = _("Guzma's advice…\n {PAUSE_UNTIL_PRESS}");
    const u8 gText_Advice19[] = _("Plumeria's advice…\n {PAUSE_UNTIL_PRESS}");
...
const u8 gText_YouWantTM[] = _("You want {STR_VAR_1}?\nThat will be ¥{STR_VAR_2}.");
...
const u8 gText_PkmnLearnedMovePause[] = _("{STR_VAR_1} learned\n{STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnMournGrewLevel[] = _("{STR_VAR_1} grew to LV. {STR_VAR_2}!");
...
const u8 gText_PartyMenu_ChooseFieldMove[] = _("Which capability?");
const u8 gText_PartyMenu_NoUse[] = _("It's no use.");//_("No use.");
...
const u8 gText_DeadPokemonState[] = _("It has perished in battle."); //TODO more based on friendship?
...
const u8 gTextSailTo_Petalburg[]  = _("Petalburg");
const u8 gTextSailTo_Slateport[]  = _("Slateport");
const u8 gTextSailTo_Littleroot[] = _("Littleroot"); //Unused?
const u8 gTextSailTo_Lilycove[]   = _("Lilycove"); //Unused?
const u8 gTextSailTo_Dewford[]    = _("Dewford");
...
const u8 gUnknown_085EB02A[] = _("Meh… Decent"); //How's your fishing? Dewford
const u8 gUnknown_085EB034[] = _("Not so good"); //How's your fishing? Dewford
...
const u8 gMatchCallDesc_MrStone[] = _("Devon Pres");
const u8 gMatchCallName_MrStone[] = _("Mr. Stone");
const u8 gMatchCallDesc_Alex[] = _("Alolan Friend");
const u8 gMatchCallName_Alex[] = _("Alex {EMOJI_HEART}");
...
const u8 gMatchCallName_Dad[] = _("Dad {EMOJI_ANGRY}");
const u8 gMatchCallDesc_Wally[] = _("{PKMN} Lover");
const u8 gMatchCallDesc_Scott[] = _("Fecking Creep");
const u8 gMatchCallName_Scott[] = _("Scott");
const u8 gMatchCallDesc_Roxanne[] = _("Rockin' Ditz");
const u8 gMatchCallDesc_Brawly[] = _("Big Show Off");
const u8 gMatchCallDesc_Wattson[] = _("Gleeful Geezer");
const u8 gMatchCallDesc_Norman[] = _("Extra Medium");
const u8 gMatchCallDesc_Flannery[] = _("Flaming Redhead");
const u8 gMatchCallDesc_Winona[] = _("Cloud Cruiser");
const u8 gMatchCallDesc_TateLiza[] = _("Double Trouble");
const u8 gMatchCallDesc_Juan[] = _("3Gay5Me");
...
const u8 gText_Whiteout_Interview[] = _("Gabby: Do you have any final words\nbefore this goes to air to millions?\p{PLAYER} curled up into a ball in\nembarrassment.");
const u8 gText_Whiteout_Embarrasment[] = _("The crowds go wild.\p{PLAYER} curled up into a ball in\nembarrassment.");
...
const u8 gText_Whiteout_RivalHero2[] = _("{RIVAL_HERO}: About time that I surpassed you…");
